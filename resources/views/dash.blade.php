...
<body>
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <a class="navbar-brand brand-logo" href="index.html"><img src="ckcmascs/images/logo.svg" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="index.html"><img src="ckcmascs/images/logo-mini.svg" alt="logo"/></a>
        </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <a class="nav-link dropdown-toggle nav-profile" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                ...
                <span class="d-none d-lg-inline animated bounce infinite">Daniel Russiel</span>
            </a>
