<template>
<div>
    <div  v-for="registrardata in registrardatas" :key="registrardata.id"  class="container-scroller">
       ...
       <!-- <center><a class="navbar-brand brand-logo" href="/">Ckcmascs.cf</a></center> -->
        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <a class="nav-link dropdown-toggle nav-profile" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                ...
                <span class="d-none d-lg-inline"> {{registrardata.name}}</span>
               
                <span class="d-none d-lg-inline teal-text ml-1" style="font-size:9px;">Office</span>
    ...
    <div class="container-fluid page-body-wrapper ">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <li v-if="registrardata.name!='Finance'" class="nav-item" :class="active3">
    ...
    methods: {
        ...
        fetchUserre(){
            axios.get('registrardata').then(
                response=>{
                    this.registrardatas=response.data.odata
