...
<div>
       ...
       <!-- <center><a class="navbar-brand brand-logo" href="/">Ckcmascs.cf</a></center> -->
        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <a class="nav-link dropdown-toggle nav-profile" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                ...
                <!-- <span class="d-none d-lg-inline"> {{fofficedata.name}}</span> -->
    ...
    <div class="container-fluid page-body-wrapper ">
        ...
        <!-- partial --> -->
        <rdash-1 v-if="pagedash"></rdash-1>
		<rregstudents v-if="pagestudents"></rregstudents>
		<rregrequest v-if="pagerequest"></rregrequest>
		<roffice v-if="pageoffice"></roffice>
    ...
    methods: {
        ...
        fetchUserre(){
            axios.get('officedata').then(
                response=>{
                    this.fofficedatas=response.data.profof
