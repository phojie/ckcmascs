...
<div>
    ...
    <div class="container-fluid page-body-wrapper ">
        ...
        <footer class="footer">
            ...
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2018 <a href="/" target="_blank">Automated Student Clearance</a>. All rights reserved.</span>
